...
/**
 * YouTube (Google) OAuth — Video upload ke liye
 *
 * YouTube Data API v3 se video upload hota hai.
 * Google OAuth 2.0 flow use hota hai.
 */
export async function GET() {
  ...
  response.cookies.set("youtube_oauth_state", state, oauthCookieOptions);
  return response;
}
